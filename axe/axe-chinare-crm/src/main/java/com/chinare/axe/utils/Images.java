...
public class Images extends org.nutz.img.Images {
     ...
     *             当读写文件失败时抛出
     */
    public static BufferedImage zoomAndClip(File src,
                                            double scale,
                                            int startX,
                                            int startY,
                                            int endX,
    ...
    public static BufferedImage zoomAndClip(File src, double scale, Point start, Point end)
            throws IOException {
    ...
    public static BufferedImage zoomAndClip(File src, double scale, Point start, int w, int h)
            throws IOException {
        return zoomAndClip(src,
                           scale,
                           start.getX(),
                           start.getY(),
                           start.getX() + w,
    ...
    public static BufferedImage zoomAndClip(String srcPath, double scale, Point start, int w, int h)
            throws Exception {
    ...
    public static NutMap baiduOcr(String path, String key) {
        ...
        Request request = Request.create("http://apis.baidu.com/apistore/idlocr/ocr",
                                         METHOD.POST,
                                         params,
